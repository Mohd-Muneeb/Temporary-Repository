...
const imagesTitles = ['image-1.png', 'image-2.png', 'image-3.png', 'image-4.png', 'image-5.png', 'image-6.png', 'image-7.png', 'image-8.png', 'image-9.png'];
...
class CustomSelect {
  constructor(originalSelect) {
    ...
    for (i = 0; i <= images.length - 1; i++) {
      ...
      itemElement.innerHTML = `<img src = "/test-images/${imagesTitles[i]}" style = "max-height: 200px; max-width: 200px;">`
